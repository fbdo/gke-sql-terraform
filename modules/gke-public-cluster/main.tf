...
module "gke_cluster" {
  source = "github.com/fbdo/terraform-google-gke.git//modules/gke-cluster?ref=v0.4.0"
...
module "vpc_network" {
  source = "github.com/fbdo/terraform-google-network.git//modules/vpc-network?ref=v0.2.1"
